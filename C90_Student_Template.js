...
{
	car1_x = car1_x + 10
	console.log("When up right arrow is pressed, x = " + car1_x + "| y = "+car1_y);
	uploadBackground()
	 uploadcar1();
	 uploadcar2();
}
...
{
	car2_x = car2_x + 10
	console.log("When up right arrow is pressed, x = " + car2_x + "| y = "+car2_y);
	uploadBackground()
	 uploadcar2();
	 uploadcar1();
}
...
if(car1_x > 700)
{
	...
	('game_status').innerHTML="Car 1 Won!!";
}
